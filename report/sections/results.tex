...
\newcommand{\twoupfigure}[6]{
  \begin{figure}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/pca-knn}
        \caption{\knn}
        \label{fig:pca-knn}
    \end{subfigure}
    ...
    ~
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{figures/pca-svm}
        \caption{SVM}
        \label{fig:pca-svm}
    \end{subfigure}
...
By inspecting which emotions are most misclassified as others across all PCA figures for each classifier we can intuitively create a emotional spectrum (figure \ref{fig:spectrum}.

\begin{figure} \label{fig:spectrum}
\centering
\begin{tikzpicture}[]
\filldraw
...
\end{tikzpicture}
\caption{A spectrum of emotions.}
\end{figure}